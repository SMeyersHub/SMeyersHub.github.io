 ...
 *
 * Loads up a menu which has options for the user to select through a keyboard input. Has
 * a switch with matching case letters to that of the menu that contains various tasks 
	...
	public static void main(String[] args) {
		...
		while (cancel.equalsIgnoreCase(menuSelect) != true) {
			...
			case 'S':
				...
				//Loops to search and increases a search result counter
