 ...
 *
 * @param <T> Element type holder that allows for any element to be put in the list.
 * 
 * This is a basic Single Linked List class that has methods to add, remove, and get/set nodes with elements in them.
 * The class allows for iteration and the iterator class can also add, remove, and check next node to see if it is valid.
 */
