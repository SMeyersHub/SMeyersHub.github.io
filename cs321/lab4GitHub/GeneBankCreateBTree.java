...
/**
 * This class builds a BTree with the specified values in it.
 * @authors Steven Meyers, Riley Schmid
 * @date 8/15/20
 */
public class GeneBankCreateBTree{
    ...
    * @param length - length of parsing string
    * @param destination - where the output will go to in a BTree
    * @throws FileNotFoundException - Error if fileName points to a nonexistent or nonreadable file
    */
    ...
    /**
     * This method takes in a bunch of the command line commands and forms a file name out of them.
     * @param name - name of the file being put in
     * @param degree - degree of the btree being put in
     * @param sequenceLength - length of the sequence being put in
     * @return fname - new file name for the output
     */
    ...
    public static void usage(){
        ...
        System.out.println();
        System.out.println("<0/1>: 0 - without Cache, 1 - with Cache");
   ...
   /**
    * This method calculates the optimalDegree using the provided numbers.
    * @return the optimal degree for the BTree
    */
   ...
   /**
    * This method turns the DNA code string into a large binary object.
    * @param code - the string of DNA code that is being turned into binary
    * @return long object that is a binary representation of the DNA code in binary
    */
