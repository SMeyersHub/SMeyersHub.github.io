...
public class JavaShell {
    ...
    // Attempts to create a class using createClass and prints errors if they occur.
    ...
    //Gets the class, all its info, and # of students
    ...
    //Gets the category and all its weights for the current selected class.
    ...
    // Attempts to create a category using addCategory and prints errors if they occur.
     ...
     */
     ...
     //Lists the assignments and their weights for the currently selected Class
    ...
    //Creates an assigment and returns the new assignment object.
    ...
    */
    ...
    //Gets all the students for the current selected class.
